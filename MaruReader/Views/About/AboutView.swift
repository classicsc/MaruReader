...
struct AboutView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(header: Text("Project"), footer: Text("Portions of MaruReader's source code form are available under the Mozilla Public License Version 2.0. See the source code repository for details.")) {
