...
enum TermFetcher {
    ...
    static func performFetch(candidates _: [LookupCandidate], context _: NSManagedObjectContext) throws -> [SearchResult] {
    ...
    static func calculateFrequency(for _: TermEntry) -> (value: Double?, mode: String?) {
        (nil, nil)
    }
}
